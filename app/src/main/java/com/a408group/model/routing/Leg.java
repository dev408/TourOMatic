...
public class Leg implements Serializable, Parcelable
{
    ...
    public final static Parcelable.Creator<Leg> CREATOR = new Creator<Leg>() {
        ...
        public Leg createFromParcel(Parcel in) {
            ...
            in.readList(instance.steps, (com.a408group.model.routing.Step.class.getClassLoader()));
            in.readList(instance.trafficSpeedEntry, (java.lang.Object.class.getClassLoader()));
            in.readList(instance.viaWaypoint, (java.lang.Object.class.getClassLoader()));
            return instance;
        }
    ...
    ;
    private final static long serialVersionUID = 8299675590783877522L;
