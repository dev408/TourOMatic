...
/**
 * An activity representing a single search_result detail screen. This
...
public class SearchResultDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       if (actionBar != null) {
        ...
        if (savedInstanceState == null) {
            ...
            String tourItemJSON = (String) b.get("TourItem");


           arguments.putString(SearchResultDetailFragment.ARG_TOUR_ITEM,tourItemJSON);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            navigateUpTo(new Intent(this, SearchResultListActivity.class));
            return true;
        }
